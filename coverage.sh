...
docker run --security-opt seccomp=unconfined -v "${PWD}:/volume" xd009642/tarpaulin sh -c "cd /volume/rusty-gb && git pull && git checkout $BRANCH && cargo tarpaulin --out Html"
